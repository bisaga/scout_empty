...
import com.bisaga.apps.empty.client.search.SearchOutline;
import com.bisaga.apps.empty.client.settings.SettingsOutline;
import com.bisaga.apps.empty.client.work.WorkOutline;
