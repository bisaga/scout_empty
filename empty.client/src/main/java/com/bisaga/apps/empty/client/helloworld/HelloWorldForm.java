package com.bisaga.apps.empty.client.helloworld;
...
import com.bisaga.apps.empty.client.helloworld.HelloWorldForm.MainBox.TopBox;
import com.bisaga.apps.empty.client.helloworld.HelloWorldForm.MainBox.TopBox.MessageField;
